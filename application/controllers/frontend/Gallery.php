...
class Gallery extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if($this->input->post('options')){
            $seo_content['page_title'] = $this->input->post('page_title');
                ...
                $this->db->where('id', 1);
                $this->db->update('front_cms_gallery_seo', $arraySeo);
                set_alert('success', translate('information_has_been_saved_successfully'));
                redirect(base_url('frontend/gallery'));
        }
        if ($_POST) {
        ...
        $this->data['testimoniallist'] = $this->gallery_model->get_list('front_cms_gallery');
    ...
    public function edit($id = '')
    {
        ...
        $this->data['testimonial'] = $this->gallery_model->get_list('front_cms_gallery', array('id' => $id), true);
        $this->data['title'] = translate('frontend');
    ...
    public function delete($id = '')
    {
        ...
        $image = $this->db->get_where('front_cms_gallery', array('id' => $id))->row()->image;
        if ($this->db->where(array('id' => $id))->delete("front_cms_gallery")) {
    ...
    public function remove($id,$galler_id)
    {
        $this->db->where(array('id' => $id))->delete("galler_images");
        set_alert('success', translate('information_has_been_updated_successfully'));
        redirect(base_url('frontend/gallery/edit/'.$galler_id));
