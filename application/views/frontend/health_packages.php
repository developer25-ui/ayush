	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('health') . " " . translate('packages'); ?></a>
			</li>
	
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add') . " " . translate('health_package'); ?></a>
			</li>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#page_content" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('page') . " " . translate('content'); ?></a>
			</li>
		...
		<div class="tab-content">
					...
					<tbody>
						...
						<tr>
							...
							<td class="min-w-xs">
									...
									<a href="<?php echo base_url('frontend/content/health_packages/edit/' . $row['id']); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>"> 
										<i class="fas fa-pen-nib"></i>
									</a>
							
									<?php echo btn_delete('frontend/content/health_packages/delete/' . $row['id']); ?>
			...
			<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="create">
			    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
				    ...
				    <div class="form-group <?php if (form_error('content')) echo 'has-error'; ?>">
						...
						<div class="col-md-8">
							<textarea name="tax_benefits" class="ckeditor"></textarea>
							<span class="error"><?php echo form_error('content'); ?></span>
						</div>
					</div>
					...
					<div class="form-group <?php if (form_error('content')) echo 'has-error'; ?>">
						...
						<div class="col-md-8">
							<textarea name="instructions" class="ckeditor"></textarea>
							<span class="error"><?php echo form_error('content'); ?></span>
						</div>
					</div>
			...
			<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="page_content">
			    <?php $health_content = $this->db->get_where('health_package_content',array('id'=>1))->row_array();?>
			    <?php echo form_open_multipart(base_url('frontend/content/health_packages_content/1'), array('class' => 'form-horizontal form-bordered')); ?>
			        
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo  translate('title'); ?> </label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="page_title" value="<?=$health_content['page_title']?>"/>
						</div>
					</div>
				<div class="form-group">
						<label class="col-md-3 control-label"><?php echo  translate('sub_heading'); ?> </label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="sub_heading" value="<?=$health_content['sub_heading']?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('photo'); ?> <span class="required">*</span></label>
						<div class="col-md-4">
							<input type="file" name="photo" class="dropify" data-height="150" data-default-file="<?=base_url($health_content['banner_image'])?>"/>
							<span class="error"><?php echo form_error('photo'); ?></span>
						</div>
					</div>
					...
					<div class="form-group <?php if (form_error('content')) echo 'has-error'; ?>">
						<label  class="col-md-3 control-label"><?php echo translate('content'); ?> </label>
						<div class="col-md-8">
							<textarea name="content" class="ckeditor"><?=$health_content['content']?></textarea>
							<span class="error"><?php echo form_error('content'); ?></span>
						</div>
					</div>
					...
					<footer class="panel-footer mt-lg">
						<div class="row">
							<div class="col-md-2 col-md-offset-3">
								<button type="submit" class="btn btn-default btn-block" name="save1" value="1">
									<i class="fas fa-plus-circle"></i> <?php echo translate('save'); ?>
								</button>
							</div>
						</div>	
			...
			<div class="tab-pane <?php echo ($validation == 6 ? 'active' : ''); ?>" id="options">
						<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal')); ?>
							<?php $home_seo = $this->db->get_where('front_cms_health_seo',array('id'=>1))->row_array();
