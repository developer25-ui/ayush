	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('procedures') . " " . translate('list'); ?></a>
			</li>
	<?php if (get_permission('frontend_procedures', 'is_add')) { ?>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add') . " " . translate('procedures'); ?></a>
			</li>
	<?php } ?>
		</ul>
					...
					<tbody>
						<?php
							...
							if (!empty($procedureslist)){ 
								foreach ($procedureslist as $row):
								?>
						<tr>
							<td><?php echo $count++; ?></td>
							<td><?php echo $row['title']; ?></td>
							<td class="min-w-xs">
								<?php if (get_permission('frontend_procedures', 'is_edit')) { ?>
								<a href="<?php echo base_url('frontend/procedures/edit/' . $row['id']); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
								<?php } ?>
								<?php if (get_permission('frontend_procedures', 'is_delete')) { ?>
									<?php echo btn_delete('frontend/procedures/delete/' . $row['id']); ?>
								<?php } ?>
							</td>
						</tr>
						<?php endforeach; }?>
