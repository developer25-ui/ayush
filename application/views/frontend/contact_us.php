	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('contact') . " " . translate('us'); ?></a>
			</li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="create">
				<?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
					...
					<!--	<label class="col-md-3 control-label">Overview Image</label>-->
					<!--	<div class="col-md-4">-->
					...
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Vision & Mission Image</label>-->
					<!--	<div class="col-md-4">-->
					...
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Corporate Profile Title</label>-->
					<!--	<div class="col-md-8">-->
					<!--		<input type="text" class="form-control" name="chairman_name" value="<?=$pagelist->chairman_name?>" />-->
					<!--	</div>-->
					<!--</div>-->
					<!--<div class="form-group">-->
					<!--	<label  class="col-md-3 control-label">Corporate Profile Content </label>-->
					<!--	<div class="col-md-8">-->
					<!--		<textarea name="chairman_message" class="form-control ckeditor"><?=$pagelist->chairman_message?></textarea>-->
					<!--	</div>-->
					<!--</div>-->
					
					
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Corporate Profile Image</label>-->
					<!--	<div class="col-md-4">-->
					<!--		<input type="file" name="chairman_image" class="dropify" data-height="150" data-default-file="<?=base_url($pagelist->chairman_image)?>"/>-->
					<!--		<span class="error"><?php echo form_error('photo'); ?></span>-->
					<!--	</div>-->
					<!--</div>-->
					
					<!--<div class="form-group">-->
					<!--	<label  class="col-md-3 control-label">Hospital Facilities</label>-->
					<!--	<div class="col-md-8">-->
					<!--		<textarea name="hospital_facilities" class="form-control ckeditor"><?=$pagelist->hospital_facilities?></textarea>-->
					<!--	</div>-->
					<!--</div>-->
					
					<!--<div class="form-group">-->
					<!--	<label  class="col-md-3 control-label">Hospital Facilities Content</label>-->
					<!--	<div class="col-md-8">-->
					<!--		<textarea name="hospital_facilities_content" class="form-control ckeditor"><?=$pagelist->hospital_facilities_content?></textarea>-->
					<!--	</div>-->
					<!--</div>-->
					
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Hospital Facilities Image</label>-->
					<!--	<div class="col-md-4">-->
					<!--		<input type="file" name="hospital_facilities_image" class="dropify" data-height="150" data-default-file="<?=base_url($pagelist->hospital_facilities_image)?>"/>-->
					<!--		<span class="error"><?php echo form_error('photo'); ?></span>-->
					<!--	</div>-->
					<!--</div>-->
					
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Certification Image 1</label>-->
					<!--	<div class="col-md-4">-->
					<!--		<input type="file" name="certification_image1" class="dropify" data-height="150" data-default-file="<?=base_url($pagelist->certification_image1)?>"/>-->
					<!--		<span class="error"><?php echo form_error('photo'); ?></span>-->
					<!--	</div>-->
					<!--</div>-->
					
					<!--<div class="form-group">-->
					<!--	<label class="col-md-3 control-label">Certification Image 2</label>-->
					<!--	<div class="col-md-4">-->
					<!--		<input type="file" name="certification_image2" class="dropify" data-height="150" data-default-file="<?=base_url($pagelist->certification_image2)?>"/>-->
					<!--		<span class="error"><?php echo form_error('photo'); ?></span>-->
					<!--	</div>-->
					<!--</div>-->
