	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('services') . " " . translate('list'); ?></a>
			</li>
					...
					<tbody>
						...
						<tr>
							...
							<td class="min-w-xs">
									...
									<a href="<?php echo base_url('frontend/services/speciality_services_edit/' . $row['id']); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>"> 
										<i class="fas fa-pen-nib"></i>
									</a>
							
									<?php echo btn_delete('frontend/services/speciality_services_delete/' . $row['id']); ?>
