...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			...
			<li class="active">
				<a href="#add_sub" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('sub_speciality'); ?></a>
			</li>
			
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="add_sub">
				<?php echo form_open_multipart(base_url('frontend/services/sub_edit_save'), array('class' => 'form-horizontal form-bordered')); ?>
