<section class="panel">
	...
	<?php if (get_permission('manage_page', 'is_add')) { ?>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>" style="display:none">
				...
				<table class="table table-bordered table-hover table-condensed table_default" cellspacing="0" width="100%">
					...
					<tbody>
						<tr>
							...
							<td>About Us</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/about_us'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
						...
						<tr>
							<td>2</td>
							<td>Health Packages</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/health_packages'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
					...
					<tr>
							...
							<td>Leadership</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/leadership'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
							...
							<tr>
							<td>1</td>
							<td>Patients Rights & Responsibilities</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/patientrights'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
						...
						<tr>
							...
							<td>Pr</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/prstoriess'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
							...
							<td>Award</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/award'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
						...
						<tr>
							...
							<td>Past Events</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/gallery'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
							...
							<td>Contact Us</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/contact_us'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
							...
							<td>Career</td>
							<td class="min-w-xs">
								<a href="<?php echo base_url('frontend/content/career'); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?php echo translate('edit'); ?>"> 
									<i class="fas fa-pen-nib"></i>
								</a>
							</td>
