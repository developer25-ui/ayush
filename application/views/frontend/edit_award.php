	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			...
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('award'); ?></a>
			</li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="create">
			    <?php echo form_open_multipart(base_url('frontend/content/award/update/'.$list['id']), array('class' => 'form-horizontal form-bordered')); ?>
