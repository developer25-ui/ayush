<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('prstoriess') . " " . translate('list'); ?></a>
			</li>
	<?php if (get_permission('frontend_prstoriess', 'is_add')) { ?>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add') . " " . translate('prstoriess'); ?></a>
			</li>
	<?php } ?>
				...
				<table class="table table-bordered table-hover table-condensed table_default" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><img class="img-border" src="<?php echo $this->app_lib->get_image_url('prstoriess/' . $row['image']); ?>" width="50"/></td>
							<td><?php echo $row['patient_name']; ?></td>
							<td><?php echo $row['surname']; ?></td>
							<td><?php echo $row['description']; ?></td>
							<td><?php echo $row['rank']; ?></td>
							<td class="min-w-xs">
								<?php if (get_permission('frontend_prstoriess', 'is_edit')): ?>
									<a href="<?php echo base_url('frontend/prstoriess/edit/' . $row['id']); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>"> 
										<i class="fas fa-pen-nib"></i>
									</a>
								<?php endif; if (get_permission('frontend_prstoriess', 'is_delete')): ?>
									<?php echo btn_delete('frontend/prstoriess/delete/' . $row['id']); ?>
								<?php endif; ?>
							</td>
						</tr>
						<?php endforeach; }?>
			...
			<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="create">
			    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="patient_name" value="<?php echo set_value('prstories_title'); ?>" />
				...
				<div class="form-group ">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="readmore"  />
						</div>
					</div>
					<div class="form-group">
	...
	<div class="tab-pane <?php echo ($validation == 6 ? 'active' : ''); ?>" id="options">
						<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal')); ?>
							<?php $home_seo = $this->db->get_where('front_cms_prstoriess_seo',array('id'=>1))->row_array();
