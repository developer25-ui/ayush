	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			...
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('leadership'); ?></a>
			</li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="create">
			    <?php echo form_open_multipart(base_url('frontend/content/leadership/update/'.$list['id']), array('class' => 'form-horizontal form-bordered')); ?>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('hospital'); ?> </label>
						<div class="col-md-6">
						    <select class="form-control" name="location" required>
                                <?php   $locations = $this->db->get('location')->result();?>
                                        <option>Select Hospital</option>
                                        <?php foreach($locations as $location){?>
                                        <option value="<?=$location->name?>" <?php if($location->name == $leadership['location']) echo "selected"; ?>><?=$location->name?></option>
                                        <?php } ?>
                            </select>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea class="form-control" id="editor" name="description" placeholder="" rows="3" ><?=$list['content']?></textarea>
						...
						<div class="col-md-6">
							<textarea class="form-control ckeditor"  name="profile" placeholder="" rows="3" ><?=$list['profile']?></textarea>
						...
						<div class="col-md-6">
							<textarea class="form-control ckeditor"  name="qualification" placeholder="" rows="3" ><?=$list['qualification']?></textarea>
