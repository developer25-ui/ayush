            ...
            <div class="panel panel-accordion">
                ...
                <div id="profile" class="accordion-body collapse <?php echo ($this->session->flashdata('profile_tab') ? 'in' : ''); ?>">
                 ...
                 <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <label class="control-label"><?php echo translate('specialty'); ?></label>
                            <select class="form-control" name="speciality" required>
                                <?php   $specialities = $this->db->get('front_cms_services_list')->result();?>
                                        ...
                                        <option value="<?=$speciality->id?>" <?php if($speciality->id == $staff['speciality']) echo "selected"; ?>><?=$speciality->title?></option>
                                        <?php } ?>
                            </select>
                        </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-control" name="blogs" required>
                                <?php   $blogss = $this->db->get('front_cms_blogs')->result();?>
                                        ...
                                        <option value="<?=$blogs->id?>" <?php if($blogs->id == $staff['blogs']) echo "selected"; ?>><?=$blogs->patient_name?></option>
                                        <?php } ?>
                            </select>
                        </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-sm">
                                        <div class="form-group">
                                            ...
                                            <textarea class="ckeditor"  name="description" ><?php echo set_value('description', $staff['description']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-md">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="user_photo" class="dropify" data-allowed-file-extensions="jpg png webp" data-default-file="<?php echo $this->app_lib->get_image_url('staff/' . $staff['photo']); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-sm">
                                        <div class="form-group <?php if (form_error('user_role')) echo 'has-error'; ?>">
                                            ...
                                            <?php
                                                ...
                                                data-minimum-results-for-search='Infinity' disabled='disabled'");
                                            ?>
                                ...
                                <div class="row mb-lg">
                                    ...
                                    <div class="col-md-6 mb-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="qualification" value="<?php echo set_value('qualification', $staff['qualification']); ?>" id="tags-input"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-lg">
                                    <div class="col-md-6 mb-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="skills" value="<?php echo set_value('skills', $staff['skills']); ?>" id="tags-input1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-sm">
                                        <div class="form-group">
                                            <label class="control-label">Rank</label>
                                              ...
                                              <input type="text" class="form-control" name="rank" value="<?php echo set_value('rank', $staff['rank']); ?>" />
                                        </div>
                                    </div>
                                     <div class="col-md-6 mb-sm">
                                        <div class="form-group">
                                ...
                                <div class="headers-line"><i class="fas fa-globe"></i> SEO Content</div>
                                <?php
							$seo_content = json_decode($staff['seo_content']);?>
