<header class="header">
	<div class="logo-env">
		<a href="<?php echo base_url('dashboard'); ?>" class="logo"><img src="<?php echo base_url('uploads/app_image/logo-small.png'); ?>" height="50"></a>
...
<?php endforeach; ?>
		...
		<div id="userbox" class="userbox">
			...
			<div class="dropdown-menu">
					...
					<li class="user-p-box">
						<div class="dw-user-box">
							...
							<div class="u-text">
								...
								<a href="<?php echo base_url('admin/logout'); ?>" class="btn btn-danger btn-xs"><i class="fas fa-sign-out-alt"></i> <?php echo translate('logout'); ?></a>
							</div>
						</div>
					</li>
				...
				<?php } ?>
					<li role="separator" class="divider"></li>
					<li><a href="<?php echo base_url('admin/logout'); ?>"><i class="fas fa-sign-out-alt"></i> <?php echo translate('logout'); ?></a></li>
				</ul>
			</div>
		</div>
	</div>
