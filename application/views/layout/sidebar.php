            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    if (get_permission('frontend_setting', 'is_view') ||
                        ...
                        get_permission('frontend_blogs', 'is_view') ||
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'frontend') echo 'nav-expanded nav-active'; ?>">
                       ...
                       <?php } if(get_permission('frontend_menu', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'frontend/menu' || $sub_page == 'frontend/menu_edit') echo 'nav-active'; ?>" style="display:none">
                        ...
                        <?php } if(get_permission('frontend_section', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'frontend/section_home' ||
                                ...
                                <a href="<?php echo base_url('frontend/section/index'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('home') . " " . translate('section'); ?></span>
                                </a>
                            </li>
                            <?php } if(get_permission('manage_page', 'is_view')){ ?>
                                    <li class="<?php if ($sub_page == 'frontend/content' || $sub_page == 'frontend/content_edit') echo 'nav-active'; ?>" >
                                        <a href="<?php echo base_url('frontend/content'); ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('pages'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="<?php if ($sub_page == 'frontend/features' || $sub_page == 'frontend/features_edit') echo 'nav-active'; ?>" style="display:none">
                            ...
                            <?php } if(get_permission('frontend_blogs', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'frontend/blogs' || $sub_page == 'frontend/blogs_edit') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('frontend/blogs'); ?>">
                                    <span><i class="fas fa-caret-right"></i><?php echo translate('blogs'); ?></span>
                                </a>
                            </li>
                             
                             <?php } if(get_permission('frontend_events', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'frontend/events' || $sub_page == 'frontend/events_edit') echo 'nav-active'; ?>" style="display:none">
                                <a href="<?php echo base_url('frontend/events'); ?>">
                                    <span><i class="fas fa-caret-right"></i><?php echo translate('events'); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="<?php if ($sub_page == 'frontend/services' || $sub_page == 'frontend/services_edit') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('frontend/services'); ?>">
                                    <span><i class="fas fa-caret-right"></i><?php echo translate('speciality'); ?></span>
                                </a>
                            </li>
                              <?php } if(get_permission('frontend_procedures', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'frontend/procedures' || $sub_page == 'frontend/procedures_edit') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('frontend/procedures'); ?>">
                                    <span><i class="fas fa-caret-right"></i><?php echo translate('procedures'); ?></span>
                                </a>
                            </li>
                    ...
                    ?>
                    <!-- Patient Details -->
                    <li class="nav-parent <?php if ($main_menu == 'patient') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                        ...
                        <?php } if(get_permission('patient_disable_authentication', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'patient/disable_authentication') echo 'nav-active'; ?>" style="display:none">
                    ...
                    ?>
                    <!-- Inventory -->
                    <li class="nav-parent <?php if ($main_menu == 'inventory' || $main_menu == 'inventory_report') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    <!-- Schedule -->
                    <li class="<?php if ($main_menu == 'schedule') echo 'nav-active'; ?>" style="display:none;">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'appointment') echo 'nav-expanded nav-active'; ?>">
                        ...
                        <?php if(get_permission('appointment', 'is_view')){ ?>
                           ...
                           <li class="" >
                                <a href="<?php echo base_url('appointment/career'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Career') . " " . translate('list'); ?></span>
                                </a>
                            </li>
                        ...
                        <?php }  if(get_permission('appointment', 'is_add')){ ?>
                            <li class="<?php if ($sub_page == 'appointment/add') echo 'nav-active'; ?>" style="display:none">
                        ...
                        <?php }  if(get_permission('appointment_request', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'appointment/requested_list') echo 'nav-active'; ?>" style="display:none">
                        ...
                        <?php }  if(loggedin_role_id() == 7){ ?>
                            <li class="<?php if ($sub_page == 'appointment/my_list') echo 'nav-active'; ?>" style="display:none">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'employee') echo 'nav-expanded nav-active'; ?>">
                        <a><i class="fas fa-users"></i><span><?php echo translate('doctor'); ?></span></a>
                        <ul class="nav nav-children">
                        <?php if(get_permission('employee', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'employee/view' ||
                                ...
                                <a href="<?php echo base_url('employee/view'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('doctor') . " " . translate('list'); ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'employee/view' ||
                                                    $sub_page == 'employee/profile' ||
                                                        $sub_page == 'employee/add_short_bio') echo 'nav-active'; ?>" style="display:none">
                                <a href="<?php echo base_url('employee/chairman'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('chairman'); ?></span>
                                </a>
                            </li>
                        ...
                        <?php } if(get_permission('employee', 'is_add')){ ?>
                            <li class="<?php if ($sub_page == 'employee/add') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('employee/create'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('add') . " " . translate('doctor'); ?></span>
                                </a>
                            </li>
                        ...
                        <?php } if(get_permission('employee_disable_authentication', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'employee/disable_authentication') echo 'nav-active'; ?>" style="display:none">
                    ...
                    ?>
                    <!-- Human Resource -->
                    <li class="nav-parent <?php if ($main_menu == 'payroll' || $main_menu == 'leave' || $main_menu == 'attendance') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    ?>
                     <!-- Lab Test Manager -->
                    <li class="nav-parent <?php if ($main_menu == 'test') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    ?>
                    <!-- Refer Manager -->
                    <li class="nav-parent <?php if ($main_menu == 'referral' || $main_menu == 'referral_report') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    ?>
                    <!-- Office Accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'accounts' || $main_menu == 'accounts_repots') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    ?>
                    <!-- Billing -->
                    <li class="nav-parent <?php if ($main_menu == 'billing' || $main_menu == 'billing_report') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'test_report') echo 'nav-expanded nav-active'; ?>" style="display:none;">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'settings') echo 'nav-expanded nav-active'; ?>">
                        ...
                        <?php } if(get_permission('sms_setting', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'smssetting/index' || $sub_page == 'smssetting/template') echo 'nav-active'; ?>" style="display:none;">
                        ...
                        <?php } if(loggedin_role_id() == 1) { ?>
                            <li class="<?php if ($sub_page == 'role/index' || $sub_page == 'role/permission') echo 'nav-active'; ?>" style="display:none;">
                        ...
                        <?php } if(get_permission('language', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'language/index' || $sub_page == 'language/word_update' || $sub_page == 'language/edit') echo 'nav-active'; ?>" style="display:none;">
                        ...
                        <?php } if(get_permission('database_backup', 'is_view') || get_permission('database_restore', 'is_add')) { ?>
                            <li class="<?php if ($sub_page == 'backup/index') echo 'nav-active'; ?>" style="display:none;">
