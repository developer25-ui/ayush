...
<section class="innerbgbanners">
 ...
 <?php $location = $this->db->get('location')->result();
                                ...
                                ?> 
  <div class="filter">
  <input type="checkbox" id="exampleFormControlSelect2" onchange="document.location.href=this.value" name="vehicle2" value="<?=base_url('doctors?location='.$value->id)?>" class="<?php if($value->id == $location_id) echo "selected";?>">
...
<h5>Specialties</h5>
 ...
 <?php $speciality = $this->db->get('front_cms_services_list')->result();
                                ...
                                ?> 
  <div class="filter">
  <input type="checkbox" id="exampleFormControlSelect1" onchange="document.location.href=this.value" name="vehicle2" value="<?=base_url('doctors?speciality='.$value->id)?>" class="<?php if($value->id == $speciality_id) echo "selected";?>">
