...
<h5>Specialties</h5>
 ...
 <?php $speciality = $this->db->get('front_cms_services_list')->result();
                                ...
                                ?> 
  <div class="filter">
  <input type="checkbox" id="exampleFormControlSelect1" onchange="document.location.href=this.value" name="vehicle2" value="<?=base_url('doctors?speciality='.$value->id)?>" <?php if($value->id == $speciality_id) echo "checked";?>>
